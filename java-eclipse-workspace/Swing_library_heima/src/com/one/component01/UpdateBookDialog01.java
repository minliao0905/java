...
public class UpdateBookDialog01 extends JDialog {
    final int WIDTH = 400;
    ...
    public UpdateBookDialog01(JFrame jf, String title, boolean isModel, ActionDoneListener listener,String id){
...
//                params.put("id",map.get("id").toString());
               ...
               try {
				booklogin.updateBook(params,id);
