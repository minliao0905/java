...
public class PostUtils {
    ...
    public static void postWithParams(String url, Map<String, String> params,SuccessListener sListener,FailListener fListener) {
        ...
        try {
            ...
            UrlEncodedFormEntity entity = new UrlEncodedFormEntity(pairs, "utf-8");  //转换？
            httpPost.setEntity(entity);
            httpPost.setHeader("Content-Type", "application/x-www-form-urlencoded");   //请求头？
            // 由客户端执行(发送)请求
